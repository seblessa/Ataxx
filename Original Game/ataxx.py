...
class ataxx():
    ...
    def game_is_over(self, red, blue):
        ...
        if blue>red:
            ...
            definirvenc.create_text(325, 25, text="        BLUE WINS          ", fill="black", font=('Helvetica 15 bold'))
            ...
            #Add a text in Canvas
            definirvenc.create_text(325, 25, text="        RED WINS          ", fill="black", font=('Helvetica 15 bold'))
            #definirvenc.create_text(325, 50, text="CARREGUE PARA VOLTAR AO MENU", fill="black", font=('Helvetica 15 bold'))
            definirvenc.pack()
        print("")
